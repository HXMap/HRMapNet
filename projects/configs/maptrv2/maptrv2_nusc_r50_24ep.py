...
data_root = '/mnt/nas/public/datasets/nuscenes/'
file_client_args = dict(backend='disk')

work_dir='/mnt/nas/usr/xiaoyu.zhang/running/maptrv2_hx_new_ep110_plot/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'maptrv2_pkl/nuscenes_map_infos_temporal_train.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'maptrv2_pkl/nuscenes_map_infos_temporal_val.pkl',
        map_ann_file=data_root + 'maptrv2_pkl/nuscenes_map_anns_val.json',
