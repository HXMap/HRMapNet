...
work_dir='/mnt/nas/usr/xiaoyu.zhang/running/maptr_hx/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'maptr_pkl/nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file=data_root + 'maptr_pkl/nuscenes_infos_temporal_val.pkl',
             map_ann_file=data_root + 'maptr_pkl/nuscenes_map_anns_val.json',
